 ...
 *
 * NOTE: The TunePicker is in a state of transition towards the common
...
goog.provide('goog.ui.TunePicker');
goog.provide('goog.ui.TunePicker.EventType');
 ...
 */
 console.log("2222")
goog.ui.TunePicker = function(opt_domHelper, opt_colorPalette) {
...
goog.inherits(goog.ui.TunePicker, goog.ui.Component);
 ...
 * @type {number}
 */
goog.ui.TunePicker.DEFAULT_NUM_COLS = 5;
 ...
 * @private
 */
goog.ui.TunePicker.prototype.focusable_ = true;
 ...
 */
goog.ui.TunePicker.prototype.getColors = function() {
 ...
 */
goog.ui.TunePicker.prototype.setColors = function(colors) {
 ...
 */
goog.ui.TunePicker.prototype.addColors = function(colors) {
 ...
 */
goog.ui.TunePicker.prototype.setSize = function(size) {
 ...
 */
goog.ui.TunePicker.prototype.getSize = function() {
 ...
 */
goog.ui.TunePicker.prototype.setColumnCount = function(n) {
  this.setSize(n);
};
 ...
 */
goog.ui.TunePicker.prototype.getSelectedIndex = function() {
 ...
 */
goog.ui.TunePicker.prototype.setSelectedIndex = function(ind) {
  if (this.colorPalette_) {
 ...
 *     color is selected.
 */
goog.ui.TunePicker.prototype.getSelectedColor = function() {
 ...
 */
goog.ui.TunePicker.prototype.setSelectedColor = function(color) {
 ...
 */
goog.ui.TunePicker.prototype.isFocusable = function() {
 ...
 */
goog.ui.TunePicker.prototype.setFocusable = function(focusable) {
 ...
 * @override
 */
goog.ui.TunePicker.prototype.canDecorate = function(element) {
  return false;
};
 ...
 * @override
 */
goog.ui.TunePicker.prototype.enterDocument = function() {
  goog.ui.TunePicker.superClass_.enterDocument.call(this);
  if (this.colorPalette_) {
...
/** @override */
goog.ui.TunePicker.prototype.disposeInternal = function() {
  goog.ui.TunePicker.superClass_.disposeInternal.call(this);
  if (this.colorPalette_) {
 ...
 */
goog.ui.TunePicker.prototype.focus = function() {
  if (this.colorPalette_) {
 ...
 * @private
 */
goog.ui.TunePicker.prototype.onColorPaletteAction_ = function(e) {
  e.stopPropagation();
  this.dispatchEvent(goog.ui.TunePicker.EventType.CHANGE);
};
 ...
 * @private
 */
goog.ui.TunePicker.prototype.createColorPalette_ = function(colors) {
  ...
  cp.setSize(goog.ui.TunePicker.DEFAULT_NUM_COLS);
 ...
 * @param {goog.dom.DomHelper=} opt_domHelper Optional DOM helper.
 * @return {!goog.ui.TunePicker} The unrendered instance.
 */
goog.ui.TunePicker.createSimpleColorGrid = function(opt_domHelper) {
  var cp = new goog.ui.TunePicker(opt_domHelper);
  cp.setSize(7);
  cp.setColors(goog.ui.TunePicker.SIMPLE_GRID_COLORS);
  return cp;
};
 ...
 * @type {Array<string>}
 */
goog.ui.TunePicker.SIMPLE_GRID_COLORS = [
  // grays
